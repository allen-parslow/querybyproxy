...
public class TerseHavingTest {
    ...
    public void visitor() {
        ...
        HqlQueryVisitorStrategyImpl impl = new HqlQueryVisitorStrategyImpl();
        impl.add(SelectClauseImpl.class, null);
        impl.visit(query.getSelect(), resolver);
    }
