...
/**
 * A basic compiler factory used a letter identification variable resolver and a
...
public class BasicQueryCompilerFactory implements QueryCompilerFactory {
    ...
    public QueryCompiler createQueryComplier() {
        return new BasicQueryCompilerImpl(
                new LetteredIdentificationVarResolver(),
                new NamedParameterResolver("p", 1));
    }
}
