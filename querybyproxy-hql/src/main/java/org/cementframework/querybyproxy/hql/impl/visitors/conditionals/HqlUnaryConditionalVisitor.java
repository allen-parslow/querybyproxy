...
/**
 * Represents a unary expression using in where and having clauses.
 * <p>
 * General form: [left-path/value] [operator]
 * </p>
 * <p>
...
public class HqlUnaryConditionalVisitor
        extends AbstractHqlCondVisitor
        implements QueryFragmentVisitor<UnaryConditionalImpl> {

    /**
     * {@inheritDoc}
     */
    public void visit(UnaryConditionalImpl conditional,
